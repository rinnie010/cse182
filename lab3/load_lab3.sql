-- Sample script file to populate the Global Logistics Schema (Lab3)
...
-- Note: Route 110 (Cargo Ship) is added so that all 4 valid vehicleType values appear in the load data.
...
110|MIA|HOU|2024-10-09 06:00:00|2024-10-15 09:00:00|2024-10-09 06:30:00|2024-10-15 09:20:00|Cargo Ship
\.
...
-- priorityClass: 'S' (Standard), 'E' (Express), 'X' (eXpedited)
-- \N denotes NULL
...
-- Two assignments are added for the new route 110 to keep the data complete.
...
-- UpdateShippingOrder(orderID, priorityClass, shippingCost)
-- Used by combine.sql (Section 2.3):
--   * orderIDs 201 and 203 already exist in ShippingOrder => UPDATE
--   * orderIDs 301 and 302 do not exist in ShippingOrder => INSERT
COPY UpdateShippingOrder FROM stdin USING DELIMITERS '|';
201|X|3000.00
203|E|2200.00
301|X|5500.00
302|S|4000.00
